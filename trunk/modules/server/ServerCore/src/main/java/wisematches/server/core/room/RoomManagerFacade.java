...
public interface RoomManagerFacade<B extends GameBoard<S, ?>, S extends GameSettings> {
     ...
     * @see wisematches.server.core.board.GameBoard#addGameMoveListener(wisematches.server.core.board.GameMoveListener)
     */
    void addGameMoveListener(GameMoveListener listener);

    /**
     * @param listener the game moves listener to be removed
     * @see wisematches.server.core.board.GameBoard#removeGameMoveListener(wisematches.server.core.board.GameMoveListener)
     */
     ...
     * @see wisematches.server.core.board.GameBoard#addGameStateListener(wisematches.server.core.board.GameStateListener)
     */
    void addGameStateListener(GameStateListener listener);

    /**
     * @param listener the game state listener to be removed
     * @see wisematches.server.core.board.GameBoard#removeGameStateListener(wisematches.server.core.board.GameStateListener)
     */
