...
import static wisematches.server.games.scribble.core.Direction.HORIZONTAL;
import static wisematches.server.games.scribble.core.Direction.VERTICAL;
...
public class ScribbleBoard extends AbstractGameBoard<ScribbleSettings, ScribblePlayerHand> implements TilesPlacement {
     ...
     */
    void setTilesBank(TilesBank tilesBank) {
        if (tilesBank == null) {
            throw new NullPointerException("TilesBank is null");
        }
        if (this.tilesBank != null) {
            throw new IllegalArgumentException("Game already has a tiles bank");
        }
