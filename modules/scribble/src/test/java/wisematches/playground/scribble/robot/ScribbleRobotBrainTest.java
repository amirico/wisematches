...
public class ScribbleRobotBrainTest {
    ...
    public void test_analizeValidMoves() {
        ...
        //
        final SortedSet<String> words = new TreeSet<>(Arrays.asList("aheh", "ahehh", "ahed", "ahedc", "load"));

        final Vocabulary dictionary = createMock(Vocabulary.class);
        expect(dictionary.getWords()).andReturn(words);
        replay(dictionary);
    ...
    public void test_putInAction() throws GameMoveException {
        ...
        final SortedSet<String> words = new TreeSet<>(Arrays.asList("ahed"));
        ...
        expect(scribbleBoard.getVocabulary()).andReturn(dictionary);
    ...
    public void test_calculateSearchTime() throws IOException {
        ...
        final SortedSet<String> hashSet = new TreeSet<>();
        ...
        for (int i = 0; i < 10; i++) {
            reset(dictionary);
            expect(dictionary.getWords()).andReturn(treeSet);
            expect(dictionary.getWords()).andReturn(hashSet);
            replay(dictionary);
