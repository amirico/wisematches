...
public class ScribbleBoardManagerTest {
    ...
    public void testLoadBoardImpl() throws BoardLoadingException {
        final ScribbleSettings settings = new ScribbleSettings("Mock", Language.EN, "mock", 3);
        ...
        expect(dictionary.getVocabulary("mock")).andReturn(vocabulary);
        replay(dictionary);

        expect(dictionaryManager.getDictionary(Language.RU)).andReturn(dictionary);
