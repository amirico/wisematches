...
public final class PlayerProfileEditor {
	...
	public PlayerProfile createProfile() {
		return new PlayerProfileDetails(creationDate, realName, countryCode, birthday, gender, primaryLanguage, comments);
	}
	...
	private static class PlayerProfileDetails implements PlayerProfile {
		...
		private PlayerProfileDetails(Date creationDate, String realName, String countryCode, Date birthday, Gender gender, Language primaryLanguage, String comments) {
