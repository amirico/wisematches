 ...
 */
public class PlayerStatisticManagerImpl implements wisematches.server.standing.statistic.PlayerStatisticManager {
	...
	protected void processPlayerMoved(GameBoard board, GameMove move) {
		...
		try {
			...
			updateWordStatistic(board, move, statistic);
		} finally {
			unlock(personality);
		}
	}
	...
	protected void updateWordStatistic(GameBoard board, GameMove move, HibernatePlayerStatistic statistic) {
//        PlayerMove playerMove = move.getPlayerMove();
//        if (playerMove instanceof Object) {
//            Object o = (Object) playerMove;
//        }
	}

	protected void updateRatingsInfo(GameBoard board, Collection<RatingChange> changes, HibernatePlayerStatistic statistic) {
		updateRatingInfo(board, statistic, statistic.getRatingsStatistic(), changes);
	}

	protected void updateRatingInfo(GameBoard board, HibernatePlayerStatistic ps, HibernateRatingsStatistic psr, Collection<RatingChange> changes) {
