...
public class MemoryProposalManagerTest {
	...
	@Test
	public void initiateGameProposal() {
		...
		final GameProposal gameProposal1 = proposalManager.initiateGameProposal(settings, 3, Arrays.asList(PERSON1));
		...
		final GameProposal gameProposal2 = proposalManager.initiateGameProposal(settings, 3, Arrays.asList(PERSON1));
	...
	@Test
	public void attachDetachPlayer() {
		final Capture<GameProposal<GameSettings>> proposalCapture = new Capture<GameProposal<GameSettings>>();
	...
	@Test
	public void getPlayerProposals() {
		final GameSettings settings = new MockGameSettings("Mock", 3);
		final GameProposal<GameSettings> proposal1 = proposalManager.initiateGameProposal(settings, 3, Arrays.asList(PERSON1));
		final GameProposal<GameSettings> proposal2 = proposalManager.initiateGameProposal(settings, 3, Arrays.asList(PERSON1, PERSON2));
		final GameProposal<GameSettings> proposal3 = proposalManager.initiateGameProposal(settings, 3, Arrays.asList(PERSON2, PERSON3, PERSON4));
