package wisematches.server.playground.scribble.bank.impl;
...
public class XMLTilesBankingHouseTest extends TestCase {
	...
	public void testGetLettersBank() {
		TilesBank tilesBank = bankingHouse.createTilesBank(Locale.ENGLISH, 2, true);
		...
		tilesBank = bankingHouse.createTilesBank(Locale.ENGLISH, 2, false);
		assertEquals(98, tilesBank.getBankCapacity()); //15 letters

		tilesBank = bankingHouse.createTilesBank(new Locale("ru"), 4, true);
