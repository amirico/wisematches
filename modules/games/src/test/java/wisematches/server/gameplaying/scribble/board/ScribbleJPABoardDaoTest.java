...
//		"classpath:/config/game-scribble-config.xml",
		...
		"classpath:/config/jpa-test.xml"})
public class ScribbleJPABoardDaoTest {
	@Autowired
	private DataSource dataSource;
	@Autowired
	private ScribbleJPABoardDao scribbleBoardDao;

	private static final Locale LOCALE = new Locale("ru");

	public ScribbleJPABoardDaoTest() {
	}
...
//		scribbleBoardDao.getJpaTemplate()..clear();
		...
		scribbleBoardDao.getJpaTemplate().remove(loaded2);
	}
