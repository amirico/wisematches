...
import wisematches.server.playground.scribble.bank.TilesBank;
import wisematches.server.playground.scribble.scores.ScoreEngine;
import wisematches.server.playground.scribble.scores.engines.ScribbleScoreEngine;
...
import static wisematches.server.playground.scribble.Direction.HORIZONTAL;
import static wisematches.server.playground.scribble.Direction.VERTICAL;
...
public class ScribbleBoard extends AbstractGameBoard<ScribbleSettings, ScribblePlayerHand> implements TilesPlacement {
	 ...
	 * @see wisematches.server.playground.scribble.board.ScribblePlayerHand
	 */
