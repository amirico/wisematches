package wisematches.server.deprecated.web.server.pproc.google;
...
public class GoogleAdSensePreProcessor implements PagePreProcessor {
	...
	private static final Log log = LogFactory.getLog("wisematches.server.deprecated.web.server.pproc.adsense");
