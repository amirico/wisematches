 ...
 */
@Deprecated
public class ContentController extends WisematchesController {
	...
	public ContentController(String... resourcesPaths) {
	 ...
	 */
	public boolean processInfoPage(String pageName, boolean reverseOrder, Model model, Locale locale) {
		return processInfoPage(pageName, pageName, reverseOrder, model, locale);
	}
	 ...
	 *         {@code false} if there is no data for specified page or page unknown.
	 */
	public boolean processInfoPage(String pageName, String infoId, boolean reverseOrder, Model model, Locale locale) {
