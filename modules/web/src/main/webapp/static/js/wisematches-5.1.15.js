...
wm.game.dict.DictionaryManager = function (readOnly, i18n) {
    ...
    var processWordChanged = function (word) {
        $.each(wordEntryEditor.find(".thesaurus"), function (i, a) {
            a = $(a);
            a.attr("href", a.attr("template").replace("{word}", word));
        });
    };
    ...
    var resetEntryEditor = function () {
        ...
        wordEntryEditor.find(".thesauruses").hide();
    ...
    this.viewWordEntry = function (entry, readOnly) {
        ...
        $('#wordEditorCancelBtn').focus();

        resetEntryEditor();

        if (entry != null) {
            processWordChanged(entry.word);
            ...
            wordEntryEditor.find(".thesauruses").hide();
            wordEntryEditor.find("#Thesauruses" + entry.language).show();
    ...
    wordEntryEditor.find(".word-input").bind('textchange', function (event, previousText) {
        processWordChanged($(this).val());
    });
};
