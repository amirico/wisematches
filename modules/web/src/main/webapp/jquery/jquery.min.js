...
(function(a, b) {
    ...
    var c = a.document,d = function() {
        ...
        var d = function(a, b) {
            return new d.fn.initializeEngine(a, b, g)
        ...
        d.fn = d.prototype = {constructor:d,initializeEngine:function(a, e, f) {
            var g,i,j,k;
            if (!a)return this;
            if (a.nodeType) {
        ...
        },push:D,sort:[].sort,splice:[].splice},d.fn.initializeEngine.prototype = d.fn,d.extend = d.fn.extend = function() {
            ...
            function a(b, c) {
                return new a.fn.initializeEngine(b, c)
            }

            d.extend(!0, a, this),a.superclass = this,a.fn = a.prototype = this(),a.fn.constructor = a,a.subclass = this.subclass,a.fn.initializeEngine = function b(b, c) {
                c && c instanceof d && !(c instanceof a) && (c = a(c));
                return d.fn.initializeEngine.call(this, b, c, e)
            },a.fn.initializeEngine.prototype = a.fn;
            var e = a(c);
            return a
