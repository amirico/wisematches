...
(function(c, j) {
    ...
    c.widget("ui.dialog", {options:{autoOpen:true,buttons:{},closeOnEscape:true,closeText:"resign",dialogClass:"",draggable:true,hide:null,height:"auto",maxHeight:false,maxWidth:false,minHeight:150,minWidth:150,modal:false,position:{my:"center",at:"center",collision:"fit",using:function(a) {
                ...
                var f = (a.uiDialogTitlebar = c("<div></div>")).addClass("ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix").prependTo(g),h = c('<a href="#"></a>').addClass("ui-dialog-titlebar-resign ui-corner-all").attr("role",
                        "button").hover(
                        function() {
                ...
                b.uiDialog.draggable({cancel:".ui-dialog-content, .ui-dialog-titlebar-resign",handle:".ui-dialog-titlebar",containment:"document",start:function(f, h) {
                            g =
...
(function(d, G) {
    ...
    d.extend(K.prototype, {markerClassName:"hasDatepicker",log:function() {
                ...
                RFC_1036:"D, d M y",RFC_1123:"D, d M yy",RFC_2822:"D, d M yy",RSS:"D, d M y",TICKS:"!",TIMESTAMP:"@",W3C:"yy-mm-dd",_ticksTo1970:(718685 + Math.floor(492.5) - Math.floor(19.7) + Math.floor(4.925)) * 24 * 60 * 60 * 1E7,formatDate:function(a, b, c) {
                    ...
                    h = !a.inline ? '<button type="button" class="ui-datepicker-resign ui-state-default ui-priority-primary ui-corner-all" onclick="DP_jQuery_' + y + '.datepicker._hideDatepicker();">' + this._get(a,
                            "closeText") + "</button>" : "";
