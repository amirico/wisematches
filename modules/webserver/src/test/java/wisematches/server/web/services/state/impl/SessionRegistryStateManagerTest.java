...
public class SessionRegistryStateManagerTest {
	...
	public void test() {
		...
		stateManager.registerNewSession("S1", new WMUserDetails(player1, "asd", "qwe", false));
		assertTrue(stateManager.isPlayerOnline(player1));
		stateManager.registerNewSession("S2", new WMUserDetails(player1, "asd", "qwe", false));
		assertFalse(stateManager.isPlayerOnline(player2));
		stateManager.registerNewSession("S3", new WMUserDetails(player2, "asd", "qwe", false));
		assertTrue(stateManager.isPlayerOnline(player2));
		stateManager.registerNewSession("S4", new WMUserDetails(player2, "asd", "qwe", false));
