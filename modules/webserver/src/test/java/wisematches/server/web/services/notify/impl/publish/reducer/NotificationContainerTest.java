...
public class NotificationContainerTest {
    ...
    public void test() {
        ...
        container.addNotification(new NotificationInfo(account, NotificationCreator.ACCOUNTS, d1, null));
        container.addNotification(new NotificationInfo(account, NotificationCreator.ACCOUNTS, d2, null));
        container.addNotification(new NotificationInfo(account, NotificationCreator.ACCOUNTS, d3, null));
        container.addNotification(new NotificationInfo(account, NotificationCreator.ACCOUNTS, d4, null));
        container.addNotification(new NotificationInfo(account, NotificationCreator.ACCOUNTS, d4, null));
        container.addNotification(new NotificationInfo(account, NotificationCreator.ACCOUNTS, d4, null));
