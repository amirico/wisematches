...
public class FilteringNotificationPublisherTest {
    ...
    public void testPublishNotification() throws Exception {
        ...
        final Capture<NotificationDeliveryServiceImpl.NotificationOld> capture = new Capture<NotificationDeliveryServiceImpl.NotificationOld>(CaptureType.ALL);
        ...
        assertFalse(p.publishNotification(new NotificationDeliveryServiceImpl.NotificationOld("asd", "asd", account, NotificationSender.ACCOUNTS)));
        assertTrue(p.publishNotification(new NotificationDeliveryServiceImpl.NotificationOld("game.state.finished", "asd", account, NotificationSender.ACCOUNTS)));
        assertFalse(p.publishNotification(new NotificationDeliveryServiceImpl.NotificationOld("game.challenge.initiated", "asd", account, NotificationSender.ACCOUNTS, model)));
        assertFalse(p.publishNotification(new NotificationDeliveryServiceImpl.NotificationOld("qwe", "asd", account, NotificationSender.ACCOUNTS)));
    ...
    private void assertTemplate(String code, String template, Account account, NotificationSender sender, Object model, NotificationDeliveryServiceImpl.NotificationOld notification) {
