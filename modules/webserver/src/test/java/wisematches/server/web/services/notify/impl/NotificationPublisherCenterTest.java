...
public class NotificationPublisherCenterTest {
    ...
    @Autowired
    private NotificationDeliveryServiceImpl notificationDistributor;
    ...
    private final Capture<NotificationDeliveryServiceImpl.NotificationOld> publishedNotifications = new Capture<>(CaptureType.ALL);
    ...
    public void setUp() throws Exception {
        final NotificationDeliveryCallback distributorListener = createStrictMock(NotificationDeliveryCallback.class);
        ...
        expect(notificationManager.getNotificationScope(isA(Personality.class), isA(String.class))).andReturn(true).anyTimes();
        ...
        notificationDistributor.setSettingsManager(notificationManager);
        ...
        expect(publisher.publishNotification(isA(NotificationDeliveryServiceImpl.NotificationOld.class))).andReturn(true).anyTimes();
        replay(publisher);
    ...
    @Test
    public void testTourneyIsComming() throws InterruptedException {
