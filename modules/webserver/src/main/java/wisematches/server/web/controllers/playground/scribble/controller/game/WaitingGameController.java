...
public class WaitingGameController extends AbstractGameController {
    ...
    private CriterionViolation checkGlobalViolation(Player principal) {
        ...
        if (globalViolation == null) {
            final int finishedGamesCount = getFinishedGamesCount(principal);
        ...
        if (globalViolation == null) {
            ...
            final Comparable expectedGamesCount = restrictionManager.getRestriction(principal, "games.active");
            if (restrictionManager.isRestricted(principal, "games.active", activeGamesCount)) {
                globalViolation = new CriterionViolation("restricted", activeGamesCount, expectedGamesCount);
            }
        }
