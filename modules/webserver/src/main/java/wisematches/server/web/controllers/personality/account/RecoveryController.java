		...
		if (form.isRecoveryAccount()) {
			...
			try {
				...
				if (player != null) {
					...
					notificationPublisher.publishNotification(new DefaultNotificationDeliveryService.NotificationOld(
		...
		if (form.isRecoveryAccount()) {
			...
			if (!result.hasErrors()) {
				...
				try {
					...
					notificationPublisher.publishNotification(new DefaultNotificationDeliveryService.NotificationOld("account.updated", player, NotificationSender.ACCOUNTS, player));
