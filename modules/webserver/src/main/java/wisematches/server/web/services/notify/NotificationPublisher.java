...
public interface NotificationPublisher {
	 ...
	 * @param mover   the original sender who initiated the notification
	 ...
	 */
	Future<Void> raiseNotification(String code, Account account, NotificationMover mover, Map<String, Object> model);
	 ...
	 * @throws NullPointerException	 if any {@code player}, {@code code} or {@code sender} is null.
	 */
	Future<Void> raiseNotification(String code, MemberPlayer player, NotificationMover mover, Map<String, Object> model);
}
