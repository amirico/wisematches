...
public interface NotificationPublisher {
	 ...
	 */
	Future<Void> raiseNotification(String code, Account account, NotificationSender sender, Map<String, Object> model);
	 ...
	 * @throws NullPointerException	 if any {@code player}, {@code code} or {@code sender} is null.
	 */
	Future<Void> raiseNotification(String code, MemberPlayer player, NotificationSender sender, Map<String, Object> model);
}
