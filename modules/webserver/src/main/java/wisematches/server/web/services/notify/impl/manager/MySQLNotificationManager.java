...
public class MySQLNotificationManager implements NotificationManager {
	...
	public NotificationSettings getNotificationSettings(Personality personality) {
		...
		final Collection<NotificationDescriptor> dcs = descriptors.values();
		final StringBuilder b = new StringBuilder();
		for (NotificationDescriptor descriptor : dcs) {
			b.append("`");
		...
		for (Iterator<NotificationDescriptor> iterator = dcs.iterator(); iterator.hasNext(); index++) {
	...
	public void setNotificationSettings(Personality personality, NotificationSettings settings) {
		...
		for (String code : descriptors.keySet()) {
	...
	private void checkNotificationTable() {
		...
		if (!names.containsAll(descriptors.keySet())) {
			final Set<String> unknown = new HashSet<String>(descriptors.keySet());
