...
public class FileProposalManagerTest {
	...
	public void loadGameProposals() throws Exception {
		...
		assertEquals(2, fileProposalManager.searchEntities(null, ProposalRightholder.ANY, null, null, null).size());

		Object[] objects = fileProposalManager.searchEntities(null, ProposalRightholder.ANY, null, null, null).toArray();
