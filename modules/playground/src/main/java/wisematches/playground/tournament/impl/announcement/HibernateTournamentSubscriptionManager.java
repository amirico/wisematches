...
public class HibernateTournamentSubscriptionManager extends AbstractTournamentSubscriptionManager implements BreakingDayListener {
    ...
    public TournamentSubscription subscribe(int announcement, Player player, Language language, TournamentSection category) throws WrongTournamentException, WrongSectionException {
        ...
        try {
            ...
            if (request == null) {
                ...
                this.announcement.changeBoughtTickets(language, category, 1);
                this.announcement.changeBoughtTickets(language, request.getSectionType(), -1);
    ...
    private void checkAnnouncementInfo(int announcement) throws WrongTournamentException {
        if (this.announcement == null) {
            throw new WrongTournamentException(announcement, 0, "No active announcements");
        }

        if (this.announcement.getNumber() != announcement) {
            throw new WrongTournamentException(announcement, this.announcement.getNumber());
        }
    }
