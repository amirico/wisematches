...
public class HibernateAnnouncement implements Announcement {
    ...
    @Override
    public int getBoughtTickets(Language language, TournamentSection category) {
        return values[language.ordinal()][tournamentCategory.ordinal()];
    }

    void setBoughtTickets(Language language, TournamentSection category, int count) {
        values[language.ordinal()][tournamentCategory.ordinal()] = count;
    }

    void changeBoughtTickets(Language language, TournamentSection category, int delta) {
