...
public interface MessageManager {
     ...
     * @param body      the message's template
    ...
    /**
     * Sent notification to specified player with specified template
     *
     * @param recipient the player who should received the message
     ...
     */
    void sendNotification(Personality recipient, String template);
     ...
     * @throws IllegalArgumentException if recipient is unknown or {@code body} is empty.
     */
    void sendNotification(Personality recipient, String template, boolean quite);
