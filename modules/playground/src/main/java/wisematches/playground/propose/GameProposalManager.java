...
public interface GameProposalManager<S extends GameSettings> {
     ...
     */
    GameWaiting<S> initiateWaitingProposal(S settings, Player initiator, int playersCount, GameRestriction restriction);
     ...
     */
    GameChallenge<S> initiateChallengeProposal(S settings, String comment, Player initiator, Collection<Player> opponents);
