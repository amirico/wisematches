...
public interface GameProposal<S extends GameSettings> {
    ...
    /**
     * Indicates that this proposal is a challenge. Challenges can be processed in another way by manager or controller.
     *
     * @return true if it's challenge; false - otherwise.
     */
    boolean isChallenge();
}
